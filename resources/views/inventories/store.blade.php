        ...
        <div>
            ...
            <form action="{{ route('accounts.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline" id="email" name="inv_code" required>
                </div>
